...
export const ContactPage: React.FC<ContactPageProps> = ({ onNavigate, prefillService }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await dispatchFormSubmission({
      ...
      subject: `[Bitsnail Technologies] Client Inquiry: ${formData.fullName.trim()} (${formData.serviceCategory}) [Ref: ${generatedId}]`,
              ...
              <div className="text-center py-6 space-y-5">
                ...
                <div className="space-y-2">
                  <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#EAF3EE] text-[#2B784E] text-xs font-bold uppercase tracking-wider">
                    ...
                    <span>Inquiry Registered & Dispatched</span>
                  </div>
                  ...
                  <p className="text-xs sm:text-sm text-[#4A5D52] max-w-md mx-auto">
                    ...
                    <strong className="text-[#2B784E]">pravinau26@gmail.com</strong> (CC: bitsnailtech@gmail.com) with official Bitsnail branding.
                  </p>
                </div>

                <div className="bg-[#F4F8F5] border border-[#DCE7E1] p-5 rounded-2xl text-left text-xs text-[#163426] space-y-2.5 max-w-md mx-auto">
                  ...
                  <div className="flex justify-between border-b border-[#E0EBE4] pb-2">
                    ...
                    <span className="font-medium">{submittedInquiry.email}</span>
                  </div>
                  <div className="flex justify-between border-b border-[#E0EBE4] pb-2">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-500">Target Operations Response:</span>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
                  <a
                    ...
                    className="w-full sm:w-auto px-6 py-3 bg-[#2B784E] hover:bg-[#1F5D3B] text-white rounded-full font-bold text-xs uppercase tracking-wider shadow-sm transition-all flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-6 py-3 bg-white hover:bg-[#F4F8F5] text-[#163426] border border-[#DCE7E1] rounded-full font-bold text-xs uppercase tracking-wider transition-all cursor-pointer"
                  >
